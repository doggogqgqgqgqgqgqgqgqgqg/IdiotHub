...
local IdiotHub = Instance.new("ScreenGui")
local MainFrame = Instance.new("ImageLabel")
local DropShadow = Instance.new("ImageLabel")
local LoadScript = Instance.new("TextButton")
local ButtonImage = Instance.new("ImageLabel")
local DropShadow_2 = Instance.new("ImageLabel")
local IdiotLogo = Instance.new("ImageLabel")
local IdiotText = Instance.new("TextLabel")
local HubText = Instance.new("TextLabel")
local GameName = Instance.new("TextLabel")

IdiotHub.Name = "IdiotHub"
IdiotHub.Parent = game.CoreGui
IdiotHub.ResetOnSpawn = false

MainFrame.Name = "MainFrame"
MainFrame.Parent = IdiotHub
MainFrame.AnchorPoint = Vector2.new(0.5, 0.5)
MainFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
MainFrame.BackgroundTransparency = 1.000
MainFrame.Position = UDim2.new(0.5,0,-1.2,0)
MainFrame.Size = UDim2.new(0, 320, 0, 208)
MainFrame.Image = "rbxassetid://"
...
IdiotLogo.Name = "IdiotLogo"
IdiotLogo.Parent = MainFrame
IdiotLogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
IdiotLogo.BackgroundTransparency = 1.000
IdiotLogo.Position = UDim2.new(0.359375, 0, 0.0249999985, 0)
IdiotLogo.Size = UDim2.new(0, 90, 0, 90)
IdiotLogo.Image = "rbxassetid://"

IdiotText.Name = "IdiotText"
IdiotText.Parent = IdiotLogo
IdiotText.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
IdiotText.BackgroundTransparency = 1.000
IdiotText.Position = UDim2.new(0.0274305344, 0, 0.99444443, 0)
IdiotText.Size = UDim2.new(0, 48, 0, 30)
IdiotText.Font = Enum.Font.Gotham
IdiotText.Text = "Idiot"
IdiotText.TextColor3 = Color3.fromRGB(255, 255, 255)
IdiotText.TextSize = 20.000

HubText.Name = "HubText"
HubText.Parent = IdiotLogo
